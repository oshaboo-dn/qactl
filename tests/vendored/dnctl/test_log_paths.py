...
import qactl.dnos as qactl
from qactl.dnos.core.paths import state_dir


PACKAGE_DIR = Path(qactl.__file__).resolve().parent
STATE_DIR = state_dir()
...
@pytest.mark.parametrize(
    "modname,attr",
    [
        ("qactl.dnos.gnmi.core.request_log", "MCP_LOG_DIR"),
        ("qactl.dnos.rc.core.request_log", "MCP_LOG_DIR"),
        ("qactl.dnos.nc.core.request_log", "MCP_LOG_DIR"),
        ("qactl.dnos.cli.core.logging", "_MCP_LOGS_DIR"),
        ("qactl.dnos.cli.core.logging", "_LOGS_DIR"),
    ],
)

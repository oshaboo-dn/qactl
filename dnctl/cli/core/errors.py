...
BACKUP_NEXT_ACTION = (
    ...
    "(`qactl cli ping <DNCTL_LOCAL_SFTP_HOST> --vrf mgmt0 -d <device>`), (2) "
...
RESTORE_NEXT_ACTION = (
    ...
    "(`qactl cli ping <DNCTL_LOCAL_SFTP_HOST> --vrf mgmt0 -d <device>`) and "
    "DNCTL_LOCAL_SFTP_PASSWORD is set (run `qactl setup --check-local-sftp` "

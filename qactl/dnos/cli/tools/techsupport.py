...
(:class:`qactl.cli.core.jobs.JobRegistry`) is shared. One active ts per device
...
from qactl.dnos.cli.core import job_store, slack_notify, ts_store
...
from qactl.dnos.cli.core.errors import CREATE_TS_NEXT_ACTION, detect_error
from qactl.dnos.cli.core.jobs import BaseJob, JobRegistry
...
from qactl.dnos.cli.core.validation import _int_in
from qactl.dnos.cli.vendors import CAP_TECHSUPPORT, requires
...
def upload_techsupport(
    ...
    if not DNFTP_PASSWORD:
        return error_response(
            ...
            "for it interactively. Set QACTL_DNFTP_PASSWORD (or "

...
The shell is always left afterwards: :func:`qactl.cli.core.shell.send_shell_exec`
...
from qactl.dnos.cli.core.errors import RUN_NCM_CLI_NEXT_ACTION, RUN_SHELL_NEXT_ACTION
from qactl.dnos.cli.core.runner import _run_ncm_on_device
from qactl.dnos.cli.core.session import DEFAULT_CMD_TIMEOUT, DEFAULT_PASSWORD, DEFAULT_USER
from qactl.dnos.cli.core.shell_exec import _build_shell_entry, run_linux_on_device
from qactl.dnos.cli.vendors import CAP_SHELL, requires

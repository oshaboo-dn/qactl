...
four serialise per-device through ``qactl.cli.core.locks.device_lock`` —
...
rollback-on-failure) is owned by ``qactl.cli.core.configure_commit``; this
...
from qactl.dnos.cli.core.configure_commit import build_configure_commit_steps, drive_configure_commit
...
from qactl.dnos.cli.vendors import CAP_CONFIGURE, CAP_FACTORY_DEFAULT, requires

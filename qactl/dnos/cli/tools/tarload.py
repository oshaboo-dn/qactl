...
Same async-job shape as :mod:`qactl.cli.tools.techsupport` (independent
:class:`qactl.cli.core.jobs.JobRegistry` instance so a stuck tar-load can't
...
:mod:`qactl.cli.core.dnftp`); tar-load has no need for it.
"""
...
from qactl.dnos.cli.core import job_store, slack_notify
from qactl.dnos.cli.core.envelope import error_response, make_response
from qactl.dnos.cli.core.errors import REQUEST_TAR_LOAD_NEXT_ACTION, detect_error
...
from qactl.dnos.cli.vendors import CAP_TARLOAD, requires

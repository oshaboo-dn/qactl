...
``qactl.cli.core.shell`` / ``qactl.cli.core.errors`` (where the rest of
...
from qactl.dnos.cli.core import errors as _errors
from qactl.dnos.cli.core import shell as _shell
from qactl.dnos.cli.vendors.base import ALL_CAPABILITIES, Dialect, VendorPlugin

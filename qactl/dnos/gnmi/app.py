...
:mod:`qactl.gnmi.tools`. Defaults match what DNOS actually accepts
...
from qactl.dnos.gnmi.tools.devices import gnmi_list_devices
from qactl.dnos.gnmi.tools.diag import gnmi_capabilities, gnmi_ping
from qactl.dnos.gnmi.tools.rw import (
    gnmi_enumerate_keys,
    gnmi_get,
    gnmi_get_many,
    gnmi_set,

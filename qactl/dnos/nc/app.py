...
Thin Typer front-end over the NETCONF tools in :mod:`qactl.nc.tools`.
...
from qactl.dnos.nc.tools.backup import (
    netconf_backup,
    netconf_diff,
...
from qactl.dnos.nc.tools.devices import netconf_list_devices
from qactl.dnos.nc.tools.diag import netconf_capabilities, netconf_ping
from qactl.dnos.nc.tools.lifecycle import (
    netconf_apply,
    netconf_discard_changes,
    netconf_rollback,
)
from qactl.dnos.nc.tools.logs import netconf_extract_logs
from qactl.dnos.nc.tools.rw import netconf_edit, netconf_get
from qactl.dnos.nc.tools.yang import netconf_get_schema, netconf_yang_library

"""MCP-level request logger (shim around qactl.core.request_log).

Concrete instance + module-level wrappers so existing imports
(``from qactl.nc.core.request_log import log_mcp_call``) keep working. The
heavy lifting is in :class:`qactl.core.request_log.RequestLogger`.
...
from qactl.dnos.core.request_log import RequestLogger

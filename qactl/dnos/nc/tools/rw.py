...
:func:`qactl.nc.core.change_ops.edit_from_xml`.
"""
...
from qactl.dnos.nc.core.change_ops import edit_from_xml
from qactl.dnos.nc.core.device_log import _begin, _log_action, _log_event
from qactl.dnos.nc.core.netconf_rpc import get, get_config
...
from qactl.dnos.nc.core.xml_payload import pretty_xml, write_output

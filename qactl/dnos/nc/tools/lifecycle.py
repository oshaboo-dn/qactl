...
- ``netconf_apply`` — multi-payload edit-config + commit driver. Reads
  ...
  :func:`qactl.nc.core.session._resolve_operation_file`).
...
from qactl.dnos.nc.core.change_ops import _change_operation, _try_commit
from qactl.dnos.nc.core.device_log import _begin, _log_action, _log_event
from qactl.dnos.nc.core.netconf_rpc import discard_changes, require_candidate, rollback

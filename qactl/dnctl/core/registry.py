...
This is the ``core/registry.py`` of the dnctl architecture: one device
...
:mod:`dnctl.core.devices`; this module is the stable public façade the
front-end imports.
"""

from __future__ import annotations

from qactl.dnctl.core.devices import (
    add_alias,

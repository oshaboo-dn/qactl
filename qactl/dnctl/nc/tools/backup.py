...
tarball store in :mod:`dnctl.nc.core.backup_store` (``<state_dir>/backups/nc``):
...
and bucket validation live in ``dnctl.nc.core.backup_store``; this module is
...
from qactl.dnctl.nc.core import backup_store
from qactl.dnctl.nc.core.change_ops import _try_commit
from qactl.dnctl.nc.core.device_log import _begin, _log_action, _log_event
from qactl.dnctl.nc.core.netconf_rpc import edit_config, get_config, require_candidate
from qactl.dnctl.nc.core.results import _base_result, _error_result
from qactl.dnctl.nc.core.session import (
    DEFAULT_PORT,
    DEFAULT_TIMEOUT,
    _connect_device,
    _session_id,
)
from qactl.dnctl.nc.core.xml_payload import (

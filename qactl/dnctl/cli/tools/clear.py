...
the state-clearing counterpart of :func:`dnctl.cli.tools.discovery.show`.
...
from qactl.dnctl.cli.core.errors import CLEAR_NEXT_ACTION
...
from qactl.dnctl.cli.core.validation import _validate_clear_command
from qactl.dnctl.cli.vendors import CAP_CLEAR, requires

...
from qactl.dnctl.cli.core.configure_commit import build_configure_commit_steps, drive_configure_commit
...
from qactl.dnctl.cli.vendors import CAP_CONFIGURE, CAP_FACTORY_DEFAULT, requires

...
funnels into :func:`dnctl.cli.core.configure_commit.drive_configure_commit`
exactly the way :func:`dnctl.cli.tools.edit.edit_config` does. So semantics
...
from qactl.dnctl.cli.core import jinja_store
from qactl.dnctl.cli.core.commit_sequence import parse_commit_output
from qactl.dnctl.cli.core.configure_commit import drive_configure_commit
...
from qactl.dnctl.cli.vendors import CAP_CONFIGURE, requires

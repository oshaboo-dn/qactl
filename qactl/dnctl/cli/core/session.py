...
from qactl.dnctl.core.cli_probe import probe_via as _probe_via
...
from qactl.dnctl.core import credentials as _creds
...
def run_once(
    ...
    from qactl.dnctl.cli.vendors.registry import dialect_for_device

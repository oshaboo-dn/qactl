...
from qactl.dnctl.cli.vendors.base import (
    ALL_CAPABILITIES,
    CAP_BACKUP,
    CAP_CLEAR,
    CAP_CONFIGURE,
...
from qactl.dnctl.cli.vendors.gate import requires, unsupported_response
from qactl.dnctl.cli.vendors.registry import (
    DEFAULT_VENDOR,
    dialect_for_device,
    get_plugin,
    plugin_for_device,
